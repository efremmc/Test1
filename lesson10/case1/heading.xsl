...
<xsl:template match="/">
   ...
   <tr>
      <td>
         <select  id="symbol" name="symbol" onchange="showReport()" >
      ...
      <td>Select a Report:<br />
         <input type="radio" name="reports" onclick="showReport()" /> Stock Overview<br />
         <input type="radio" name="reports" onclick="showReport()" /> Current Values<br />
         <input type="radio" name="reports" onclick="showReport()" /> Five-Day Reports<br />
         <input type="radio" name="reports" onclick="showReport()" /> Yearly Summaries
      </td>
   </tr>
   </table>
